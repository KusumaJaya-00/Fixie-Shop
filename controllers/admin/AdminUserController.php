...
class AdminUserController
{
    ...
    public function create(): void
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (!empty($errors)) {
                $this->renderUsersListWithErrors($errors);
                return;
            }
        }
    ...
    public function edit(): void
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (!empty($errors)) {
                $this->renderUsersListWithErrors([], ['edit_' . $id => $errors]);
                return;
            }
        }
    ...
    private function renderUsersListWithErrors(array $createErrors = [], array $editErrorsByUserId = []): void
    {
        $userModel = new User($this->db);
        $users = $userModel->all();
        $errors = array_merge($createErrors, $editErrorsByUserId);
